...
say "\nNot koha-plugin-edifact-harrassowitz, exiting" && exit 0 unless $repo eq "koha-plugin-edifact-harrassowitz";
...
foreach my $repo (@repos) {
    next if $repo eq 'koha-plugin-edifact-harrassowitz';
    next if $repo eq 'koha-plugin-edifact-harrassowitz-docs';
