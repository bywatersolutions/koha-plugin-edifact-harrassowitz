...
use Koha::Database;
use Koha::Items;
use Koha::Plugin::Com::ByWaterSolutions::EdifactHarrassowitz;
use Koha::Plugin::Com::ByWaterSolutions::EdifactHarrassowitz::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactHarrassowitz->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactHarrassowitz::Edifact::Order
        ->new(
        {
